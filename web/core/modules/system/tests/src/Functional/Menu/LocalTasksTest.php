...
class LocalTasksTest extends BrowserTestBase {
  ...
  public function testPluginLocalTask(): void {
    ...
    $this->drupalGet(Url::fromRoute('menu_test.local_taREDACTED_SK_TEST_view'));
    $this->assertLocalTasks([
      ['menu_test.local_taREDACTED_SK_TEST_view', []],
      ['menu_test.local_taREDACTED_SK_TEST_edit', []],
      ['menu_test.local_taREDACTED_SK_TEST_settings', []],
      ['menu_test.local_taREDACTED_SK_TEST_settings_dynamic', []],
    ]);
    ...
    $sub_tasks = [
      ['menu_test.local_taREDACTED_SK_TEST_settings_sub1', []],
      ['menu_test.local_taREDACTED_SK_TEST_settings_sub2', []],
      ['menu_test.local_taREDACTED_SK_TEST_settings_sub3', []],
      ['menu_test.local_taREDACTED_SK_TEST_settings_derived', ['placeholder' => 'derive1']],
      ['menu_test.local_taREDACTED_SK_TEST_settings_derived', ['placeholder' => 'derive2']],
    ];
    $this->drupalGet(Url::fromRoute('menu_test.local_taREDACTED_SK_TEST_settings'));
    ...
    $this->drupalGet(Url::fromRoute('menu_test.local_taREDACTED_SK_TEST_settings_sub1'));
    $this->assertLocalTasks($sub_tasks, 1);
    ...
    $this->drupalGet(Url::fromRoute('menu_test.local_taREDACTED_SK_TEST_settings_derived', ['placeholder' => 'derive1']));
    $this->assertLocalTasks($sub_tasks, 1);
    ...
    $this->assertEquals('menu_test', $definitions['menu_test.local_taREDACTED_SK_TEST_view']['provider']);
    $this->assertEquals('menu_test', $definitions['menu_test.local_taREDACTED_SK_TEST_edit']['provider']);
    $this->assertEquals('menu_test', $definitions['menu_test.local_taREDACTED_SK_TEST_settings']['provider']);
    $this->assertEquals('menu_test', $definitions['menu_test.local_taREDACTED_SK_TEST_settings_sub1']['provider']);
    $this->assertEquals('menu_test', $definitions['menu_test.local_taREDACTED_SK_TEST_settings_sub2']['provider']);
    $this->assertEquals('menu_test', $definitions['menu_test.local_taREDACTED_SK_TEST_settings_sub3']['provider']);
    ...
    $this->drupalGet(Url::fromRoute('menu_test.local_taREDACTED_SK_TEST_sub1', ['entity_test' => '1']));

    $tasks = [
      ['menu_test.local_taREDACTED_SK_TEST_sub1', ['entity_test' => '1']],
      ['menu_test.local_taREDACTED_SK_TEST_sub2', ['entity_test' => '1']],
    ];
    ...
    $this->drupalGet(Url::fromRoute('menu_test.local_taREDACTED_SK_TEST_sub2', ['entity_test' => '1']));
