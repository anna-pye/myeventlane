...
class LocalTaskManagerTest extends UnitTestCase {
  ...
  public function testGetLocalTasksForRouteSingleLevelTitle(): void {
    ...
    $local_tasks = $this->manager->getLocalTasksForRoute('menu_local_taREDACTED_SK_TEST_view');
  ...
  public function testGetLocalTasksForRouteForChild(): void {
    ...
    $local_tasks = $this->manager->getLocalTasksForRoute('menu_local_taREDACTED_SK_TEST_child1_page');
  ...
  public function testGetLocalTaskForRouteWithEmptyCache(): void {
    ...
    $this->cacheBackend->get('local_task_plugins:en:menu_local_taREDACTED_SK_TEST_view')
      ->shouldBeCalled();
    ...
    $this->cacheBackend->set('local_task_plugins:en', $definitions, Cache::PERMANENT, ["local_task"])
      ->shouldBeCalled();
    $this->cacheBackend->set('local_task_plugins:en:menu_local_taREDACTED_SK_TEST_view', $this->getLocalTasksCache(), Cache::PERMANENT, ['local_task'])
      ->shouldBeCalled();
  ...
  protected function getLocalTaskFixtures(): array {
    $definitions = [];
    $definitions['menu_local_taREDACTED_SK_TEST_settings'] = [
      'route_name' => 'menu_local_taREDACTED_SK_TEST_settings',
      'title' => 'Settings',
      'base_route' => 'menu_local_taREDACTED_SK_TEST_view',
    ];
    $definitions['menu_local_taREDACTED_SK_TEST_edit'] = [
      'route_name' => 'menu_local_taREDACTED_SK_TEST_edit',
      'title' => 'Settings',
      'base_route' => 'menu_local_taREDACTED_SK_TEST_view',
      'weight' => 20,
    ];
    ...
    // confuses them.
    $definitions['menu_local_taREDACTED_SK_TEST_view.tab'] = [
      'route_name' => 'menu_local_taREDACTED_SK_TEST_view',
      'title' => 'Settings',
      'base_route' => 'menu_local_taREDACTED_SK_TEST_view',
    ];

    $definitions['menu_local_taREDACTED_SK_TEST_view_child1'] = [
      'route_name' => 'menu_local_taREDACTED_SK_TEST_child1_page',
      'title' => 'Settings child #1',
      'parent_id' => 'menu_local_taREDACTED_SK_TEST_view.tab',
    ];
    $definitions['menu_local_taREDACTED_SK_TEST_view_child2'] = [
      'route_name' => 'menu_local_taREDACTED_SK_TEST_child2_page',
  ...
  protected function getLocalTasksForRouteResult($mock_plugin): array {
    $result = [
      0 => [
        'menu_local_taREDACTED_SK_TEST_settings' => $mock_plugin,
        'menu_local_taREDACTED_SK_TEST_view.tab' => $mock_plugin,
        'menu_local_taREDACTED_SK_TEST_edit' => $mock_plugin,
      ],
      1 => [
        'menu_local_taREDACTED_SK_TEST_view_child1' => $mock_plugin,
        'menu_local_taREDACTED_SK_TEST_view_child2' => $mock_plugin,
      ],
    ];
    return $result;
  }
  ...
  protected function getLocalTasksCache(): array {
    ...
    $local_tasks = [
      'base_routes' => [
        'menu_local_taREDACTED_SK_TEST_view' => 'menu_local_taREDACTED_SK_TEST_view',
      ],
      'parents' => [
        'menu_local_taREDACTED_SK_TEST_view.tab' => TRUE,
      ],
      'children' => [
        '> menu_local_taREDACTED_SK_TEST_view' => [
          'menu_local_taREDACTED_SK_TEST_settings' => $local_task_fixtures['menu_local_taREDACTED_SK_TEST_settings'],
          'menu_local_taREDACTED_SK_TEST_edit' => $local_task_fixtures['menu_local_taREDACTED_SK_TEST_edit'],
          'menu_local_taREDACTED_SK_TEST_view.tab' => $local_task_fixtures['menu_local_taREDACTED_SK_TEST_view.tab'],
        ],
        'menu_local_taREDACTED_SK_TEST_view.tab' => [
          // The manager will fill in the base_route before caching.
          'menu_local_taREDACTED_SK_TEST_view_child1' => ['base_route' => 'menu_local_taREDACTED_SK_TEST_view'] + $local_task_fixtures['menu_local_taREDACTED_SK_TEST_view_child1'],
          'menu_local_taREDACTED_SK_TEST_view_child2' => ['base_route' => 'menu_local_taREDACTED_SK_TEST_view'] + $local_task_fixtures['menu_local_taREDACTED_SK_TEST_view_child2'],
        ],
      ],
    ];
    $local_tasks['children']['> menu_local_taREDACTED_SK_TEST_view']['menu_local_taREDACTED_SK_TEST_settings']['weight'] = 0;
    $local_tasks['children']['> menu_local_taREDACTED_SK_TEST_view']['menu_local_taREDACTED_SK_TEST_edit']['weight'] = 20 + 1e-6;
    $local_tasks['children']['> menu_local_taREDACTED_SK_TEST_view']['menu_local_taREDACTED_SK_TEST_view.tab']['weight'] = 2e-6;
    $local_tasks['children']['menu_local_taREDACTED_SK_TEST_view.tab']['menu_local_taREDACTED_SK_TEST_view_child1']['weight'] = 3e-6;
    $local_tasks['children']['menu_local_taREDACTED_SK_TEST_view.tab']['menu_local_taREDACTED_SK_TEST_view_child2']['weight'] = 4e-6;
    return $local_tasks;
  }
  ...
  public function testGetTasksBuildWithCacheabilityMetadata(): void {
    ...
    $definitions['menu_local_taREDACTED_SK_TEST_settings']['cache_tags'] = ['tag.example1'];
    $definitions['menu_local_taREDACTED_SK_TEST_settings']['cache_contexts'] = ['context.example1'];
    $definitions['menu_local_taREDACTED_SK_TEST_edit']['cache_tags'] = ['tag.example2'];
    $definitions['menu_local_taREDACTED_SK_TEST_edit']['cache_contexts'] = ['context.example2'];
    // Test the cacheability metadata of access checking.
    $definitions['menu_local_taREDACTED_SK_TEST_view_child1']['access'] = AccessResult::allowed()->addCacheContexts(['user.permissions']);

    $this->setupFactoryAndLocalTaskPlugins($definitions, 'menu_local_taREDACTED_SK_TEST_view');
    $this->setupLocalTaskManager();
    ...
    $this->routeMatch->expects($this->any())
      ->method('getRouteName')
      ->willReturn('menu_local_taREDACTED_SK_TEST_view');
    $this->routeMatch->expects($this->any())
      ->method('getRawParameters')
      ->willReturn(new InputBag());

    $cacheability = new CacheableMetadata();
    $this->manager->getTasksBuild('menu_local_taREDACTED_SK_TEST_view', $cacheability);
  ...
  public function testGetLocalTasks($new_weights, $expected): void {
    ...
    $definitions['menu_local_taREDACTED_SK_TEST_view_a_child'] = [
      'route_name' => 'menu_local_taREDACTED_SK_TEST_a_child_page',
      'title' => 'Settings child a_child',
      'parent_id' => 'menu_local_taREDACTED_SK_TEST_view.tab',
      'id' => 'menu_local_taREDACTED_SK_TEST_view_a_child',
      'route_parameters' => [],
      'base_route' => '',
      'weight' => 0,
      'options' => [],
    ...
    foreach ([0, 1] as $level) {
      $local_tasks = $this->manager->getLocalTasks('menu_local_taREDACTED_SK_TEST_view', $level);
    ...
    return [
      ...
      'weights_from_fixture' => [
        ...
        'expected' => [
          // Level 0.
          [
            'menu_local_taREDACTED_SK_TEST_settings',
            'menu_local_taREDACTED_SK_TEST_view.tab',
            'menu_local_taREDACTED_SK_TEST_edit',
          ],
          // Level 1. All weights are 0, so the sort is alphabetical.
          [
            'menu_local_taREDACTED_SK_TEST_view_a_child',
            'menu_local_taREDACTED_SK_TEST_view_child1',
            'menu_local_taREDACTED_SK_TEST_view_child2',
          ],
        ],
      ],
